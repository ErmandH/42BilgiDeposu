...
CKEDITOR.ClassicEditor.create(document.getElementById("editor1"), {
    ...
    .then(editor => {
        editor1 = editor
        const id = $('#editor2').data('id')
        $.ajax({
            url: '/admin/project/get-short-description/' + id,
            type: 'GET',
            success: (res) => {
                editor1.setData(res)
            }
...
let editor2; // editor2 nin datasini alacagim obje
CKEDITOR.ClassicEditor.create(document.getElementById("editor2"), {
    ...
    .then(editor => {
        ...
        const id = $('#editor2').data('id')
        $.ajax({
            url: '/admin/project/get-description/' + id,
            type: 'GET',
            success: (res) => {
                editor2.setData(res)
            }
...
$('#update-form').submit((e) => {
    e.preventDefault()
    if (editor1.getData() == '' || editor2.getData() == '') {
    ...
    $.ajax({
        ...
        success: (res) => {
            if (res.response == true) {
                bootbox.alert('Proje başarıyla güncellendi', () => {
